...
var toggleSlideClasses$1 = /* @__PURE__ */ __name((slideEl, condition, className) => {
...
var toggleSlideClasses = /* @__PURE__ */ __name((slideEl, condition, className) => {
  if (condition && !slideEl.classList.contains(className)) {
    slideEl.classList.add(className);
  } else if (!condition && slideEl.classList.contains(className)) {
    slideEl.classList.remove(className);
    ...
    (typeof swiper.params.controller.control === "string" || swiper.params.controller.control instanceof HTMLElement)) {
      ...
      controlElements.forEach((controlElement) => {
        ...
        if (controlElement && controlElement.swiper) {
          ...
          const onControllerSwiper = /* @__PURE__ */ __name((e) => {
...
function A11y(_ref) {
  ...
  const onVisibilityChange = /* @__PURE__ */ __name((e) => {
...
function Autoplay(_ref) {
  ...
  const onPointerEnter = /* @__PURE__ */ __name((e) => {
    ...
    if (typeof thumbs.swiper === "string" || thumbs.swiper instanceof HTMLElement) {
      ...
      const getThumbsElementAndInit = /* @__PURE__ */ __name(() => {
        ...
        if (thumbsElement && thumbsElement.swiper) {
          ...
          const eventName = `${swiper.params.eventsPrefix}init`;
          const onThumbsSwiper = /* @__PURE__ */ __name((e) => {
...
function Grid(_ref) {
  ...
  const updateSlide = /* @__PURE__ */ __name((i, slide2, slides) => {
    const {
      slidesPerGroup
    } = swiper.params;
...
function updateSwiper(_ref) {
  ...
  const destroyModule = /* @__PURE__ */ __name((mod) => {
...
var formatValue = /* @__PURE__ */ __name((val) => {
...
var _DummyHTMLElement = class _DummyHTMLElement {
};
__name(_DummyHTMLElement, "DummyHTMLElement");
var DummyHTMLElement = _DummyHTMLElement;
...
var arrowSvg = `<svg width="11" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.38296 20.0762C0.111788 19.805 0.111788 19.3654 0.38296 19.0942L9.19758 10.2796L0.38296 1.46497C0.111788 1.19379 0.111788 0.754138 0.38296 0.482966C0.654131 0.211794 1.09379 0.211794 1.36496 0.482966L10.4341 9.55214C10.8359 9.9539 10.8359 10.6053 10.4341 11.007L1.36496 20.0762C1.09379 20.3474 0.654131 20.3474 0.38296 20.0762Z" fill="currentColor"/></svg>
    `;
var addStyle = /* @__PURE__ */ __name((shadowRoot, styles) => {
...
var _SwiperContainer = class _SwiperContainer extends ClassToExtend {
  constructor() {
    super();
    this.attachShadow({
      mode: "open"
...
__name(_SwiperContainer, "SwiperContainer");
var SwiperContainer = _SwiperContainer;
...
var _SwiperSlide = class _SwiperSlide extends ClassToExtend {
  constructor() {
    super();
    this.attachShadow({
      mode: "open"
...
__name(_SwiperSlide, "SwiperSlide");
var SwiperSlide = _SwiperSlide;
var register = /* @__PURE__ */ __name(() => {
