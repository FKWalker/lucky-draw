...
var defaults = {
  ...
  enableSeconds: false,
  enableTime: false,
  errorHandler: /* @__PURE__ */ __name(function(err) {
    return typeof console !== "undefined" && console.warn(err);
  }, "errorHandler"),
  getWeek: /* @__PURE__ */ __name(function(givenDate) {
...
var english = {
  ...
  firstDayOfWeek: 0,
  ordinal: /* @__PURE__ */ __name(function(nth) {
    var s = nth % 100;
    if (s > 3 && s < 21)
      return "th";
    switch (s % 10) {
...
var revFormat = {
  D: doNothing,
  F: /* @__PURE__ */ __name(function(dateObj, monthName, locale) {
    dateObj.setMonth(locale.months.longhand.indexOf(monthName));
  }, "F"),
  G: /* @__PURE__ */ __name(function(dateObj, hour) {
    dateObj.setHours((dateObj.getHours() >= 12 ? 12 : 0) + parseFloat(hour));
  }, "G"),
  H: /* @__PURE__ */ __name(function(dateObj, hour) {
    dateObj.setHours(parseFloat(hour));
  }, "H"),
  J: /* @__PURE__ */ __name(function(dateObj, day) {
    dateObj.setDate(parseFloat(day));
  }, "J"),
  K: /* @__PURE__ */ __name(function(dateObj, amPM, locale) {
    dateObj.setHours(dateObj.getHours() % 12 + 12 * int(new RegExp(locale.amPM[1], "i").test(amPM)));
  }, "K"),
  M: /* @__PURE__ */ __name(function(dateObj, shortMonth, locale) {
    dateObj.setMonth(locale.months.shorthand.indexOf(shortMonth));
  }, "M"),
  S: /* @__PURE__ */ __name(function(dateObj, seconds) {
    dateObj.setSeconds(parseFloat(seconds));
  }, "S"),
  U: /* @__PURE__ */ __name(function(_, unixSeconds) {
    return new Date(parseFloat(unixSeconds) * 1e3);
  }, "U"),
  W: /* @__PURE__ */ __name(function(dateObj, weekNum, locale) {
    var weekNumber = parseInt(weekNum);
    var date = new Date(dateObj.getFullYear(), 0, 2 + (weekNumber - 1) * 7, 0, 0, 0, 0);
    date.setDate(date.getDate() - date.getDay() + locale.firstDayOfWeek);
    return date;
  }, "W"),
  Y: /* @__PURE__ */ __name(function(dateObj, year) {
    dateObj.setFullYear(parseFloat(year));
  }, "Y"),
  Z: /* @__PURE__ */ __name(function(_, ISODate) {
    return new Date(ISODate);
  }, "Z"),
  d: /* @__PURE__ */ __name(function(dateObj, day) {
    dateObj.setDate(parseFloat(day));
  }, "d"),
  h: /* @__PURE__ */ __name(function(dateObj, hour) {
    dateObj.setHours((dateObj.getHours() >= 12 ? 12 : 0) + parseFloat(hour));
  }, "h"),
  i: /* @__PURE__ */ __name(function(dateObj, minutes) {
  ...
  l: doNothing,
  m: /* @__PURE__ */ __name(function(dateObj, month) {
    dateObj.setMonth(parseFloat(month) - 1);
  }, "m"),
  n: /* @__PURE__ */ __name(function(dateObj, month) {
    dateObj.setMonth(parseFloat(month) - 1);
  }, "n"),
  s: /* @__PURE__ */ __name(function(dateObj, seconds) {
    dateObj.setSeconds(parseFloat(seconds));
  }, "s"),
  u: /* @__PURE__ */ __name(function(_, unixMillSeconds) {
...
var formats = {
  Z: /* @__PURE__ */ __name(function(date) {
    return date.toISOString();
  }, "Z"),
  D: /* @__PURE__ */ __name(function(date, locale, options) {
    return locale.weekdays.shorthand[formats.w(date, locale, options)];
  }, "D"),
  F: /* @__PURE__ */ __name(function(date, locale, options) {
    return monthToStr(formats.n(date, locale, options) - 1, false, locale);
  }, "F"),
  G: /* @__PURE__ */ __name(function(date, locale, options) {
    return pad(formats.h(date, locale, options));
  }, "G"),
  H: /* @__PURE__ */ __name(function(date) {
    return pad(date.getHours());
  }, "H"),
  J: /* @__PURE__ */ __name(function(date, locale) {
    return locale.ordinal !== void 0 ? date.getDate() + locale.ordinal(date.getDate()) : date.getDate();
  }, "J"),
  K: /* @__PURE__ */ __name(function(date, locale) {
    return locale.amPM[int(date.getHours() > 11)];
  }, "K"),
  M: /* @__PURE__ */ __name(function(date, locale) {
    return monthToStr(date.getMonth(), true, locale);
  }, "M"),
  S: /* @__PURE__ */ __name(function(date) {
    return pad(date.getSeconds());
  }, "S"),
  U: /* @__PURE__ */ __name(function(date) {
    return date.getTime() / 1e3;
  }, "U"),
  W: /* @__PURE__ */ __name(function(date, _, options) {
    return options.getWeek(date);
  }, "W"),
  Y: /* @__PURE__ */ __name(function(date) {
    return pad(date.getFullYear(), 4);
  }, "Y"),
  d: /* @__PURE__ */ __name(function(date) {
    return pad(date.getDate());
  }, "d"),
  h: /* @__PURE__ */ __name(function(date) {
    return date.getHours() % 12 ? date.getHours() % 12 : 12;
  }, "h"),
  i: /* @__PURE__ */ __name(function(date) {
    return pad(date.getMinutes());
  }, "i"),
  j: /* @__PURE__ */ __name(function(date) {
    return date.getDate();
  }, "j"),
  l: /* @__PURE__ */ __name(function(date, locale) {
    return locale.weekdays.longhand[date.getDay()];
  }, "l"),
  m: /* @__PURE__ */ __name(function(date) {
    return pad(date.getMonth() + 1);
  }, "m"),
  n: /* @__PURE__ */ __name(function(date) {
  ...
  w: /* @__PURE__ */ __name(function(date) {
    return date.getDay();
  }, "w"),
  y: /* @__PURE__ */ __name(function(date) {
...
function FlatpickrInstance(element, instanceConfig) {
  ...
  function setupHelperFunctions() {
    self.utils = {
      getDaysInMonth: /* @__PURE__ */ __name(function(month, yr) {
        if (month === void 0) {
  ...
  function buildMonthNav() {
    ...
    Object.defineProperty(self, "_hidePrevMonthArrow", {
      ...
      set: /* @__PURE__ */ __name(function(bool) {
  ...
  function parseConfig() {
    ...
    Object.defineProperty(self.config, "enable", {
      ...
      set: /* @__PURE__ */ __name(function(dates) {
